...
if __name__ == '__main__':
	...
	parser.add_argument("--train_path", type=str, default=r"H:\dataset\bihua\training\images")
	parser.add_argument("--mask_path", type=str, default=r"H:\dataset\disocclusion_img_mask")
	parser.add_argument("--val_path", type=str, default=r"H:\dataset\bihua\validating\images")
	...
	log_dir = os.path.join(cwd,args.log_dir)
	model_dir = os.path.join(cwd,args.save_dir)
	...
	if args.load_model:
		assert os.path.isfile(os.path.join(model_dir,args.load_model))

		filename = os.path.join(model_dir,args.load_model)
